...
#define PRESSURE_CONTROL_DONE 0x00000002   //Pressure control done (Pressure in chamber 1013mbar)
...
enum NioReworkReason
{
	...
	IpReRefOutsideLimit = 14,		// Reference current on RE (20µA) out of tolerance
...
struct ProcessDataTrimming
{
	...
	float ActUn;    //actual Nernst voltage (cyclic measurement)
	float ActUape;  //actual APE voltage (cyclic measurement)
...
enum class EProcessStep
{
	...
	Heating,
	MeasureIpRefCell1,
	WaitingpPrtialPressureReached,
	IPuStabilityCheck,
	GasControl,
	StartIPu4Meas, // Only I4 Average or IP4 2-point measurement
	WaitIPu4MeasDone,
	CheckBmwQualification,
	CheckDieselQualification,
	Trimming,
	WaitTrimmingFinished,
	TrimmingFinished,	
	MeasureIPRefAfterTrimming,
	Labeling,
	SavePartsJournal,
	CoolingSelection,
	StartCoolingPassive,
...
private:
	...
	ProcessType eProcessType {}; //precess type
...
public:
	...
	SETrimmingChamber(int);	//constructor
	...
	void BmwQualification(ProcessType eType);
